  ...
  return (
    <div>
        ...
        <div className="absolute text-white my-64 mx-auto right-0 left-0 text-center bg-black mr-40 ml-40 p-20 rounded-lg bg-opacity-25">
            ...
            <form>
                <input type="text" placeholder="Email address" className="p-4 m-4 my-4 rounded-lg bg-gray-900 w-3/12"></input>
                <button className="bg-red-600 p-4 my-4 rounded-lg hover:bg-red-700 font-semibold w-2/12 text-lg">Get Started > </button>
            </form>
        </div>
    </div>
  )
